    ...
    <main className="h-screen w-full flex items-center justify-center  md:bg-gray-100 md:p-30">
      {loading ? (
        ...
        <form className="p-10 bg-white flex flex-col justify-center items-start gap-5 rounded-2xl md:drop-shadow-xl w-full md:w-2xl" onSubmit={handleUpdate}>
          ...
          <button className="bg-blue-500 p-4 w-full rounded-md text-white text-center mt-5 disabled:bg-gray-500 disabled:cursor-not-allowed hover:scale-95 transition-transform disabled:scale-100" disabled={ loading || !title || (!content && !hasFile) }>Update</button>
