...
export default function NavBar() {
  ...
  return (
    <nav className="p-4 flex justify-between items-center bg-white drop-shadow-md absolute top-0 left-0 w-full z-50">
      <h1 onClick={() => navigate("/")} className="text-2xl font-bold cursor-pointer">Blog App</h1>
